...
public static partial class Errors
{
    public static class AverageRating
    {
        ...
        public static Error ScoreIsNull(int numRatings) => Error.Validation(
            ...
            description: $"Average Rating Score is NULL: With {numRatings} ratings or reviews found for this entity, the Average Rating Score should be a number between {ValueObjects.AverageRating.Constraints.MinScore} and {ValueObjects.AverageRating.Constraints.MaxScore}, but was returned with value of NULL.");


        public static Error OutOfRange(double? avgRatingResult, int numRatings) => Error.Validation(
