...
public static partial class Errors
{
    public static class ProductLine
    {
        public static Error InvalidNameLength => Error.Validation(
            ...
            description: $"The Name for a Product Line must be between {ProductLineAggregate.ProductLine.MinNameLength} and {ProductLineAggregate.ProductLine.MaxNameLength} characters long.");
